    ...
    >
      <q-list>
        <q-expansion-item dense style="font-size: 12px;"
                          label="All about QDraggableTree"
                          header-class="text-primary" :expanded-icon="biCaretUp" :expand-icon="biCaretDown"
                          expand-icon-class="text-primary')"
        >
          <q-card class="bg-transparent">
            <q-list>
              <q-item class="text-primary q-ml-md" :active-class="$route.path=='/'?'bg-grey-3':''" to="/" dense
                      clickable>
                <q-item-section>
        ...
        >
          <q-card class="bg-transparent">
            <q-item class="text-primary q-ml-md"
                    :active-class="$route.path=='/example-qdraggabletree-basic'?'bg-grey-3':''"
                    to="/example-qdraggabletree-basic" dense clickable>
              <q-item-section>
                QDraggableTree Basic
              </q-item-section>
            </q-item>
            <q-item class="text-primary q-ml-md"
                    :active-class="$route.path=='/example-qdraggabletree-slot-demo'?'bg-grey-3':''"
                    to="/example-qdraggabletree-slot-demo" dense clickable>
              <q-item-section>
                QDraggableTree Slot Demo
              </q-item-section>
            </q-item>
          </q-card>
        </q-expansion-item>
        ...
        >
          <q-card class="bg-transparent">
            <q-item class="text-primary q-ml-md" :active-class="$route.path=='/sponsor'?'bg-grey-3':''" to="/sponsor"
                    dense clickable>
              <q-item-section>
                Sponsor
              </q-item-section>
